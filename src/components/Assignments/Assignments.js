...
const placeholderText = ["Projektledning", "Ledarskap", "Utbildning","Marknadsaktivitet","Intrim Uppdrag"];
    ...
    <div>
      <div className="hero">
        <div className="overlay">
          <div class="centered text-white">Behöver du hjälp med <br></br><span className="text-warning">{placeholderText[index]}</span> ?</div>
        </div>
      </div>
